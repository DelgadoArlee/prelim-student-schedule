...
export default function SubjectInputButton(props: { studentId?: number, setSchedule: Dispatch<SetStateAction<SubjectCard[]>>}) {
    ...
    const [allDa, disableCheckboxes] = useState(false);
            ...
            >
                ...
                >
                    <div>
                        ...
                        <FormControl>
                            <RadioGroup row>
                                <FormControlLabel value="male" control={<Radio size="small" />} label="Lecture" />
                                <FormControlLabel value="other" control={<Radio size="small" />} label="Lab" />
                            </RadioGroup>
                        </FormControl>
